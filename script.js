...
const EVENTS = [
  { id: "baraat", icon: "assets/event/pn-evt-ico-ghurchari-horse-v01.png", name: "Departure of Baraat", date: "", time: "2:00 PM", venue: "From Residence", note: '<a class="farman-directions-link" href="https://goo.gl/maps/nDotUNwFroUA1y1a9?g_st=ac" target="_blank" rel="noopener noreferrer">Get directions to home</a>', map: "" },
